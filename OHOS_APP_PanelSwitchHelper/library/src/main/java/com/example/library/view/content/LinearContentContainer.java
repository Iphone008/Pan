...
public class LinearContentContainer extends DirectionalLayout implements IContentContainer {
    ...
    public LinearContentContainer(Context context, AttrSet attrSet) {
        this(context, attrSet, null);
        initView(context, attrSet, "");
    }

    public LinearContentContainer(Context context, AttrSet attrSet, String styleName) {
