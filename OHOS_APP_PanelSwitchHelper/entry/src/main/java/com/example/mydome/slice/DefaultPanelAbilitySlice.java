...
public class DefaultPanelAbilitySlice extends AbilitySlice {
    ...
    static final HiLogLabel LABEL = new HiLogLabel(HiLog.LOG_APP, 0xD001500, DefaultPanelAbilitySlice.class.getName());

    @Override
    public void onStart(Intent intent) {
        super.onStart(intent);
        super.setUIContent(ResourceTable.Layout_ability_default_height_panel);
...
//        mListContainer.setItemProvider(mChatProvider);
        ...
        findComponentById(ResourceTable.Id_titleText).setClickedListener(component -> {
            new ToastDialog(this).setText("已清除面板高度缓存，可拉起功能面板测试默认高度").show();
        });
    }
