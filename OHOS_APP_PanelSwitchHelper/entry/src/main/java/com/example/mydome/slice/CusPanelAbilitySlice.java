...
public class CusPanelAbilitySlice extends AbilitySlice {
    ...
    static final HiLogLabel LABEL = new HiLogLabel(HiLog.LOG_APP, 0xD001500, CusPanelAbilitySlice.class.getName());

    @Override
    public void onStart(Intent intent) {
        super.onStart(intent);
        super.setUIContent(ResourceTable.Layout_ability_cus_panel);
